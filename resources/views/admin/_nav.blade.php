<ul class="nav nav-tabs my-3">
    ...
    <li class="nav-item"><a class="nav-link {{ ($route == 'pricelist')?'active':'' }}"
                            href="{{ route('admin.pricelist.index') }}">Прайс лист</a></li>
    <li class="nav-item"><a class="nav-link {{ ($route == 'calculator')?'active':'' }}"
                            href="{{ route('admin.calculator.index') }}">Калькулятор</a></li>
    ...
    <li class="nav-item"><a class="nav-link {{ ($route == 'loans')?'active':'' }}"
                            href="{{ route('admin.loans.index') }}">Кредитование</a></li>
    <li class="nav-item"><a class="nav-link {{ ($route == 'advice')?'active':'' }}"
                            href="{{ route('admin.advice.index') }}">Советы</a></li>
    <li class="nav-item"><a class="nav-link {{ ($route == 'faq')?'active':'' }}" href="{{ route('admin.faq.index') }}">FAQ</a>
    </li>
</ul>
