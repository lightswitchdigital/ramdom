...
@section('content')
    ...
    <div class="d-flex flex-row mb-3">
        <a href="{{ route('admin.projects.attributes.edit', $attribute) }}" class="btn btn-primary mr-1">Изменить</a>
        <form method="POST" action="{{ route('admin.projects.attributes.destroy', $attribute) }}" class="mr-1">
            @csrf
            @method('DELETE')
