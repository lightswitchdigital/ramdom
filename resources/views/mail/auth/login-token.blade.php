                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="500" class="wrapper">
                    ...
                    <tr>
                        <td style="padding: 20px 0px 30px 0px;" class="logo">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="#F6FAFB" width="100" align="left"><a href="#" target="_blank"><img
                                                alt="Logo" src="{{ asset('/images/logo.svg') }}" width="100"
            ...
            <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td style="padding: 20px 0px 20px 0px;">
                        <!-- UNSUBSCRIBE COPY -->
                        <table role="presentation" width="500" border="0" cellspacing="0" cellpadding="0" align="center"
                               class="responsive-table">
                            <tr>
                                <td align="center" valign="middle"
                                    style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                    <span class="appleFooter" style="color:#666666;">Все права защищены © 2012 -2020, Договор-оферта, Политика конфиденциальности</span><br><a
                                        class="original-only" href="https://lightswitch.digital"
                                        style="color: #666666; text-decoration: none;">LightSwitch</a>
                                </td>
                            </tr>
                        </table>
                    </td>
