                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="500" class="wrapper">
                    ...
                    <tr>
                        <td style="padding: 20px 0px 30px 0px;" class="logo">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="#F6FAFB" width="100" align="left"><a href="http://rbc.work" target="_blank"><img alt="Logo" src="{{ asset('/img/logo.png') }}" width="100" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;" border="0"></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                    ...
                                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                <!-- ТЕКСТ 2 -->
                                                Только что было запрошено восстановление пароля вашего аккаунта. Если вы этого не делали, просто проигнорируйте это письмо. В ином случае перейдите по ссылке ниже:
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table role="presentation" width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                            <tr>
                                <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                    <span class="appleFooter" style="color:#666666;">Все права защищены © 2012 -2020, Договор-оферта, Политика конфиденциальности</span><br><a class="original-only" href="https://lightswitch.digital" style="color: #666666; text-decoration: none;">LightSwitch</a>
                                </td>
                            </tr>
                        </table>
                    </td>
